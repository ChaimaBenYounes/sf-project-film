 ...
 */
final class Version20190125110350 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE movie (id INT AUTO_INCREMENT NOT NULL, producer_id INT DEFAULT NULL, title VARCHAR(255) NOT NULL, date DATETIME NOT NULL, INDEX IDX_1D5EF26F89B658FE (producer_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
